                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                        className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 bg-gray-50 text-gray-800 placeholder-gray-500"
                      />
                    </div>
                  </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          required
                          min={getTodayDate()}
                          className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 bg-gray-50 text-gray-800"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          onChange={handleChange}
                          required
                          min={trip.startDate || getTodayDate()}
                          className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 bg-gray-50 text-gray-800"
                        />
                      </div>
                    </div>
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-xl border border-blue-100">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-600 mt-1">After creating your trip, you’ll be able to add detailed itineraries, accommodations, and activities!</p>
                    </div>
                  </div>
                </div>
              </div>
