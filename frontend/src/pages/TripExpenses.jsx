...
//   {expenses.map(e => (
//   <div key={e._id} className="bg-gray-100 p-3 rounded mb-3 shadow">
//     <h4 className="font-bold">{e.title} - ₹{e.amount}</h4>
//     <p className="text-sm">Paid by: {e.paidBy.name}</p>
...
//       <button onClick={() => populateEditForm(e)} className="text-blue-600 text-sm">Edit</button>
//       <button onClick={() => handleDelete(e._id)} className="text-red-500 text-sm">Delete</button>
//     </div>
//   </div>
// ))}

// // Pre-fill form to edit
// const populateEditForm = (expense) => {
//   setForm({
//     ...expense,
//     splitAmounts: expense.splitAmounts.map(s => ({
...
//           <button onClick={() => handleSplitTypeChange('equal')} className="text-blue-600 text-sm">Split Equally</button>
//           <button onClick={addSplit} className="text-blue-600 text-sm">+ Custom Split</button>
//         </div>

//         {form.splitAmounts.map((s, i) => (
//           <div key={i} className="flex gap-2">
//             <select className="border p-2 w-1/2" value={s.user}
//               onChange={e => handleSplitChange(i, 'user', e.target.value)}>
...
//               ))}
//             </select>
//             <input type="number" className="border p-2 w-1/3" placeholder="Amount"
//               value={s.amount} onChange={e => handleSplitChange(i, 'amount', e.target.value)} />
...
//           {editingId ? (
//           <button onClick={handleEdit} className="bg-green-600 text-white px-4 py-2 rounded">Save Changes</button>
//         ) : (
...
//             ))}
//           </ul>
//           <button onClick={() => handleDelete(e._id)} className="text-red-500 text-sm mt-2">Delete</button>
//         </div>
//       ))}
...
//               {user?.name}: Spent ₹{val.spent || 0}, Owes ₹{val.owes || 0}
//             </div>
//           );
//         })}
//       </div>
//       <div className="bg-yellow-100 p-4 mt-4 rounded">
//         <h3 className="font-bold mb-2">Who Owes Whom</h3>
//         {transactions.length === 0 ? (
...
//               const from = members.find(m => m._id === t.from)?.name || 'Unknown';
//               const to = members.find(m => m._id === t.to)?.name || 'Unknown';
//               return <li key={i}>{from} pays ₹{t.amount.toFixed(2)} to {to}</li>;
//             })}
//           </ul>
//         )}
//       </div>
...
//       <h3 className="font-bold mb-2">Expenses Chart</h3>
//       <ResponsiveContainer width="100%" height={300}>
//         <BarChart data={chartData}>
...
//           <Bar dataKey="owes" fill="#f87171" name="Owes" />
//         </BarChart>
//       </ResponsiveContainer>
//     </div>
//     </div>
